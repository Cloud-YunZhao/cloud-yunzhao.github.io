...
======
* **含软弱夹层的露天矿边坡稳定性分析**   
  以某露天矿山为工程背景,通过工程地质报告确定了具体的研究区域。然后通过室内试验获取了相应的岩石力学指标。在此基础上，分析了边坡稳定性的影响因素。结合现场地质调查后，确定最主要影响因素为软弱夹层。为研究软弱夹层对边坡稳定性的影响，采用正交试验法，使用有限差分软件FLAC 3D进行数值模拟计算。以边坡安全系数为判据，分析了软弱夹层倾角、厚度、粘聚力、内摩擦角、与坡脚的距离五个因素对边坡的稳定性影响程度。最后对开采现状和开采终了边坡进行稳定性分析。该研究获湖北省优秀学士学位论文。
